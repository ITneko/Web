...
<%@ page import="java.util.*, exDay1229_.model.*" %> 
<%
...
%>
        ...
        <font face="돋움" size="2" color="#000000"><a class="list" href ="guest_view.do?idx=<%=list.get(x).getIdx()%>&page=${page}"><%=list.get(x).getSubject() %></a>
		      </td>
			 ...
			 <table width="500">
							<tr>
								...
								<td width="50%" align="center">
									<table>
										<form name="b_search" action="guest_list.do" method="post">
