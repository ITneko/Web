				...
				<table border="0" cellspacing="1" width="100%" align="center">
					...
					<tr>
						<td colspan="5" align="right" valign="middle" height="20"><font
							size="2" face="고딕">전체 : <b><%=totcount%></b>건 - 1/ 2 Pages
						</font></td>
					</tr>
					<tr bgcolor="e3e9ff">
					...
					<tr onMouseOver="style.backgroundColor='#D1EEEE'"
						...
						<%
								...
								String query2 = "select * from tbl_board order by idx desc";
					...
					<tr onMouseOver="style.backgroundColor='#D1EEEE'"
						...
						<td align="left" height="20">&nbsp; <font face="돋움" size="2"
							color="#000000"> <a class="list" href="board_view.jsp?idx=<%=rs.getInt("idx")%>"><%=rs.getString("subject") %></a></td>
