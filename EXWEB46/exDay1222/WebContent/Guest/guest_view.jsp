...
<%
	...
	String query = "update tbl_guest2 set readcnt=readcnt+1 where idx=?";
	pstmt = conn.prepareStatement(query);
	pstmt.setInt(1, idx);
	pstmt.executeUpdate();
	query = "select * from tbl_guest2 where idx=?";
	pstmt = conn.prepareStatement(query);
	pstmt.setInt(1, idx);
       ...
       <p>
         ...
         <tr>
           <td class="content">
             ...
             <%=name %> <  / <font size="2" face="돋움"><%=regdate.substring(0,10) %> / <%=ip %> / <%=readcnt %>번 읽음</font>
             <p>
             <%=contents %><p>
           </td>
         </tr>
         ...
         <tr>
           <td class="content">
             <p align="right"><font size="2" face="돋움">
              <%=name %>  / <font size="2" face="돋움"><%=regdate.substring(0,10) %> / 최근 수정: <%=editdate %> / <%=ip %> /<%=readcnt %>번 읽음</font>
             <p>
             <%=contents %><p>
           </td>
         </tr>
