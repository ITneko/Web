...
<tr>
  <td width="20%"  bgcolor="#ecf1ef" valign="top" style="padding-left:0;">
	...
	<script>
		function del_list(){
			var url = "Board?cmd=board_delete&idx=" + ${idx} +"&page=" + ${page};
			window.open(url, "del_list"," resizable=no,x=300,y=300,width=300,height=170");
		}
	</script>
	   </td>
      ...
      <font size="2">
       <!-- 새글쓰기 -->
       <a href="Board?cmd=board_write&idx=${idx }&page=${page}">
       <img src="Board/img/write.jpg" border="0"></a>&nbsp;&nbsp;
	   <!-- 수정하기 -->
       <a href="Board?cmd=board_modify&idx=${idx }&page=${page}">
       <img src="Board/img/edit.gif" border="0"></a>&nbsp;&nbsp;
         <!-- 삭제하기 -->
       <a href="javascript:del_list()"><img src="Board/img/del.gif" border="0"></a>&nbsp;&nbsp;
       <!-- 목록보기 -->
       <a href="javascript:history.back()"><img src="Board/img/list-2.gif" border="0"></a>&nbsp;&nbsp;
      </font>
    </td>
  </tr>
  </table>
