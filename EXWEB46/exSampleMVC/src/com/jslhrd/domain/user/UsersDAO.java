...
public class UsersDAO {
	...
	// id search
	public String userSearch(String tel) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String userid = null;

		String query = "select userid from tbl_users_sec where tel=?";
		try {
			conn = DBManager.getConnection();
			pstmt = conn.prepareStatement(query);
	...
	// passwd reset
		public int userPasswdReset(String pass, String userid, String email) {
			Connection conn = null;
			PreparedStatement pstmt = null;
			ResultSet rs = null;
			int row = 0;

			String query = "update tbl_users_sec set passwd=? where userid=? and email=?";
			try {
				conn = DBManager.getConnection();
				pstmt = conn.prepareStatement(query);
