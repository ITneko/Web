...
<!--  <%@ include file="/Include/login_form.jsp" %>-->
  ...
  <td width="80%" valign="top">&nbsp;<img src="Users/img/title1.gif" ><br>    
	<form name="users" method="post" action="User?cmd=user_modify_pro">
					...
					<td bgcolor="#7AAAD5">            
						...
						<table cellpadding=3 cellspacing=1 border=0 width=100%>
							...
							<tr>
								...
								<TD BGCOLOR=WHITE>
								<input type=password name=newpasswd size=8 maxlength=12 style="width:80">
									새로운 비밀번호는 6~12자 이내의 영문이나 숫자만 가능합니다.
								</td>
							</tr>
							<tr>
								<TD BGCOLOR="#EFF4F8">&nbsp;새로운비밀번호확인<font color=red>&nbsp;*</font></td>
								<TD BGCOLOR=WHITE><input type=password name=newrepasswd size=8 maxlength=12 value="" style="width:80">새로운 비밀번호 확인을 위해서 비밀번호를 한번 더 입력해주세요. </td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td bgcolor=WHITE valign=middle>
									<input type="text" name="email1" maxlength="15" value="${user.email }" readonly>
