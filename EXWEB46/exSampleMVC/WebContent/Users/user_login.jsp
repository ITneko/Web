...
<script>
	function idsearch(){
		var url = "User?cmd=user_idsearch";
		window.open(url, "idsearch", "width=350 , height=300");
	}
	function passwdsearch(){
		var url = "User?cmd=user_passwdsearch";
		window.open(url, "idsearch", "width=350 , height=300");
	}
...
<TR>
  ...
  <TD>
    <table width="583" border="0" cellspacing="0" cellpadding="0" height="265">
	  <form name=fname method=post action="User?cmd=user_login_ok"  onSubmit="return check_submit()">
	    <tr>
		  <td height="298"> 
				     ...
				     <tr bgcolor="#FFFFFF"> 
					  ...
					  <tr bgcolor="#FFFFFF"> 
						<td bgcolor="#ffffff" align=CENTER height="138"> 
							<a href="javascript:idsearch()">[아이디찾기]</a> &nbsp;&nbsp; <a href="javascript:passwdsearch()">[비밀번호찾기]</a>
						</td>
					  </tr>
