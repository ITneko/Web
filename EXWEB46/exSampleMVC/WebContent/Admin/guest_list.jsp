                  ...
                  <tr>
                    <td><table width="100%" border="0" cellpadding="6" cellspacing="1" bgcolor="DDDDDD">
                      ...
                      <c:if test="${empty list }">
                        <td align="center" bgcolor="#FFFFFF" colspan="5">게시물이 없습니다.</td>
                      ...
                      <c:forEach var="list" items="${list }">
                        ...
                        <td bgcolor="#FFFFFF"><img src="Admin/img/btn/icon_re.gif" border=0><a class="list" href="AdminGuest?cmd=guest_view&idx=${list.idx}">${list.subject }</a></td>
                      ...
                      <tr>
                        <td colspan="10" align="center" bgcolor="#FFFFFF"><table width="610" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width=20% align="right"><b>[검색]</b>  &nbsp;<a href="guest_write?page=${page }"><b>[글쓰기]</b></a></td>
                            </tr>
                        </table></td>
                      </tr>
                    </table>
