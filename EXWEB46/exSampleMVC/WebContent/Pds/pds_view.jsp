 ...
 <link rel="stylesheet" type="text/css" href="/stylesheet.css">
   ...
   <script>
   	function pds_down(filename){
   		...
   		location.href = "Pds?cmd=pds_down&filename="+escapeFile;
   	}
   	
   	function del_(){
		var url = "Pds?cmd=pds_delete&idx=${vo.idx}&page=${page}";
...
<%@ include file="/Include/login_form.jsp" %>
  ...
  <p align="center">
  <font size="2">
   <a href="Pds?cmd=pds_modify&idx=${vo.idx }&page=${page}"><img src="Pds/img/edit-1.gif" border="0">&nbsp;&nbsp;&nbsp;&nbsp;</a>
   <a href="javascript:del_()"><img src="Pds/img/del.gif" border="0">&nbsp;&nbsp;&nbsp;&nbsp;</a>
  <a href="Pds?cmd=pds_list"><img src="Pds/img/list-2.gif" border="0"></a></font></td></tr>  
</table>  
</body>  
</html>
