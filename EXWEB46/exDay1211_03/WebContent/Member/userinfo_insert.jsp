...
<script>
	function send() {
		var members = document.getElementsByName("fa");
		var count = 0;
										...
										<td bgcolor="#7AAAD5">
											...
											<table cellpadding=3 cellspacing=1 border=0 width=100%>
													...
													<TD BGCOLOR=WHITE>
														<table cellspacing=0 cellpadding=0>
															<tr>
																...
																<td><img src="Memeber/img/u_bt01.gif" hspace=2
																	border=0 name=img1 align=absmiddle> 5~16자 이내의
																	영문이나 숫자만 가능합니다.</td>
															</tr>
														</table>
													</td>
												...
												<tr>
													...
													<TD BGCOLOR=WHITE><input type=radio name=gubun>직장&nbsp;&nbsp;
														<input type=radio name=gubun>자택</td>
												</tr>
											...
											<table cellpadding=0 cellspacing=0 border=0 width=100%>
												<tr bgcolor=#7AAAD5>
													<td valign=bottom><img src="Memeber/img/u_b04.gif"
														align=left hspace=0 vspace=0 border=0></td>
													<td align=center></td>
													<td valign=bottom><img src="Memeber/img/u_b05.gif"
														align=right hspace=0 vspace=0 border=0></td>
												</tr>
												<tr bgcolor=#ffffff>
													<td colspan=3 align=center><img
														src="Memeber/img/u_bt06.gif" vspace=3 border=0 name=img3
														OnClick="send()"> <img src="Memeber/img/u_bt05.gif"
